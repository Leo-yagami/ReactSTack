...
const data = [
  ...
  return (
    <>
      ...
      {/* Cards wrapper */}
      <div className='flex justify-center text-white text-center bg-[#FFFFFF] flex-wrap gap-6 mx-12 mt-40 mb-20'>
        {/* Pricing card */}
        <div className='hover:bg-[#F6670B] duration-500 rounded-3xl'>
          <div className='bg-[#03243B] max-w-md max-h-fit px-10 pt-12 pb-8 rounded-xl min-h-[920px] flex flex-col m-3'>
        ...
        <div className='hover:bg-[#F6670B] duration-500 rounded-3xl'>
          <div className='bg-[#03243B] max-w-md px-10 pt-12 pb-8 m-3 rounded-xl min-h-[920px] flex flex-col'>
